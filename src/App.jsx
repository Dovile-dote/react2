  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <section>
          {
            dogs.map((dog, i) => dog[0] !== dog[0].toUpperCase() ? <div className="apskritimas" key={i}>{dog}</div>:<div key={i}></div>)
          }
        </section>

        <section>
          {
            dogs2.map((dog, i) => <div className="suo" key={i}>
              <div className="kaire-ausis"></div>
              <div className="snukis">
                <div className="akys">
                  <div className='rainele'><div className='vizdys'></div></div>
                  <div className='rainele'><div className='vizdys'></div></div>
                </div>
                <p>{dog}</p>
              </div>
